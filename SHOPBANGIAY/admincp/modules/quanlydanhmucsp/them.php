...
<head>
    ...
    <script>
        function validateForm() {
            var tendanhmuc = document.forms["myForm"]["tendanhmuc"].value;
            var thutu= document.forms["myForm"]["thutu"].value;
...
<body>
<div style="display:flex; width:1000px;"><div style="width:500px;"></div><div style="width:250px; text-align:center;font-size:30px;"></div><div style="width:560px;"></div><div style="width:260px;"></div></div>


<p style="font-size:30px;"><b>Thêm danh mục sản phẩm</b></p>
<hr style="margin-top:-20px;">
 <table border="1" width="50%" style="border-collapse: collapse;">
   <form name="myForm" onsubmit="return validateForm()" method="POST" action="modules/quanlydanhmucsp/xuly.php">
    <tr>
