...
<?php 
                        ...
                        } elseif($bientam=='quanlydanhmucsanpham' && $query=='lietke') {
                        ...
                        } elseif($bientam=='quanlysanpham' && $query=='lietke'){
                        ...
                        }elseif($bientam=='thongkedoanhthu' && $query=='thongke'){
                            include("modules/thongkedoanhthu/dashboard.php");
