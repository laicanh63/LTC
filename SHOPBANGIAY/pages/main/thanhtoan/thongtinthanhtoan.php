...
<div class="container">
    ...
    <form action="thanhtoan.php" method="POST">
        <div class="row">
            ...
            <table style="width:100%; text-align: center; border-collapse: collapse;" border="2">
                ...
                if(isset($_SESSION['cart']) && is_array($_SESSION['cart']) && !empty($_SESSION['cart'])){
                    ...
                    <tr>
                        <td colspan="8">
                            <h3 style="float: left; color: black;"> Tổng tiền: </h3> 
                            <h3 style="padding-left:5px ; float: left; color: red;"><?php  echo number_format($tongtien,0,',','.') . ' VNĐ'  ?></h3>
        ...
        <div class="col-md-4 hinhthucthanhtoan">
			...
			<div class="form-check">
			  <input class="form-check-input" type="radio" name="payment" id="exampleRadios3" value="vnpay" checked>
			  <img src="../../../images/vnpay.png" height="20" width="64">
			  <label class="form-check-label" for="exampleRadios3">
			    VNPAY
			  </label>
			</div>
            <input type="submit" value="Thanh toán nhanh" name="redirect"  class="btn btn-danger">
        </form>
        <p></p>
        <?php
        $tongtien = 0;
