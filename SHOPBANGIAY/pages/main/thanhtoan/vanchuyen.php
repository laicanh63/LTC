...
<div class="col-md-8">
    ...
    ?>
        <tr style="border:2px solid black;">
            ...
            <td><a href="../giohang/xoasanpham.php?xoa=<?php echo $cart_item['id'] ?>" class="btn btn-success">XÓA</a></td>
        </tr>
    ...
    ?>
        ...
        <tr>
            <td colspan="8">
                <h3 style="float: left; color: black;"> Tổng tiền : </h3> <h3 style="padding-left:5px ; float: left; color: red;"><?php  echo number_format($tongtien,0,',','.') . ' VNĐ'  ?></h3>
                ...
                <div style="clear: both;"> </div>
                    ...
                    ?>
                            <p><a href="index.php?quanly=thongtinthanhtoan" class="hinhthuc">Hình thức thanh toán</a></p>
                    <?php
                    }else{
